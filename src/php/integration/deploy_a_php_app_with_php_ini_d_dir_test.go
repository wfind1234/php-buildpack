...
var _ = Describe("CF PHP Buildpack", func() {
	...
	Context("deploying a basic PHP5 app with custom conf files in php.ini.d dir in app root", func() {
		BeforeEach(func() {
			app = cutlass.New(filepath.Join(bpDir, "cf_spec", "fixtures", "php_5_with_php_ini_d"))
		})
	...
	Context("deploying a basic PHP7 app with custom conf files in php.ini.d dir in app root", func() {
		BeforeEach(func() {
			app = cutlass.New(filepath.Join(bpDir, "cf_spec", "fixtures", "php_7_with_php_ini_d"))
		})
	...
	Context("deploying a basic PHP71 app with custom conf files in php.ini.d dir in app root", func() {
		BeforeEach(func() {
			app = cutlass.New(filepath.Join(bpDir, "cf_spec", "fixtures", "php_71_with_php_ini_d"))
		})
	...
	Context("deploying an app with an invalid extension in php.ini.d dir", func() {
		BeforeEach(func() {
			app = cutlass.New(filepath.Join(bpDir, "cf_spec", "fixtures", "invalid_php_ini_d"))
		})
