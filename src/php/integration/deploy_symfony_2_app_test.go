...
var _ = Describe("CF PHP Buildpack", func() {
	...
	It("deploying a symfony 2.1 app with locally-vendored dependencies", func() {
		...
		app = cutlass.New(filepath.Join(bpDir, "cf_spec", "fixtures", "symfony_2_local_deps"))
	...
	It("deploying a symfony 2.1 app with remotely-sourced dependencies", func() {
		...
		app = cutlass.New(filepath.Join(bpDir, "cf_spec", "fixtures", "symfony_2_remote_deps"))
	...
	It("deploying a symfony 2.8 app", func() {
		app = cutlass.New(filepath.Join(bpDir, "cf_spec", "fixtures", "symfony_28_remote_deps"))
		app.SetEnv("COMPOSER_GITHUB_OAUTH_TOKEN", os.Getenv("COMPOSER_GITHUB_OAUTH_TOKEN"))
		PushAppAndConfirm(app)
