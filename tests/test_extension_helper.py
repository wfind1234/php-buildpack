...
class TestPHPExtensionHelper(object):
    def setUp(self):
        ...
        shutil.copy('defaults/config/php/5.6.x/php.ini',
                    self.phpCfgDir)
        shutil.copy('defaults/config/php/5.6.x/php-fpm.conf',
                    self.phpCfgDir)
    ...
    def test_basic(self):
        ...
        eq_(os.path.join(self.phpCfgDir, 'fpm.d'), ext._php_fpm_path)
        eq_(1963, len(ext._php_ini._lines))
        eq_(522, len(ext._php_fpm._lines))
    ...
    def test_merge_defaults(self):
        ...
        eq_('5.6.30', ext._ctx['PHP_VERSION'])
